...
const slides: CarouselSlide[] = [
  { id: "opportunity", code: "01", channel: "Opportunity intelligence", title: "See the value signals inside your business.", copy: "DREAMS Score organizes six connected opportunity areas into one calmer, clearer business review.", image: "/media/overview.png", alt: "DREAMS Score opportunity intelligence overview" },
  { id: "debt", code: "D", channel: "Debt & Funding", title: "Make capital decisions with more clarity.", copy: "Review debt structure, business-credit priorities, and funding questions worth a closer specialist conversation.", image: "/media/debt.png", alt: "DREAMS Score Debt and Funding opportunity panel" },
  { id: "retirement", code: "R", channel: "Retirement", title: "Strengthen the benefits engine.", copy: "Explore retirement-plan efficiency, participation, and employee-benefit design through a focused business lens.", image: "/media/retirement.png", alt: "DREAMS Score Retirement opportunity panel" },
  { id: "expenses", code: "E", channel: "Expenses", title: "Stop overpaying where it matters most.", copy: "Surface questions around premiums, technology, and payroll taxes that may deserve a qualified cost review.", image: "/media/expenses.png", alt: "DREAMS Score Expenses opportunity panel" },
  { id: "assets", code: "A", channel: "Assets", title: "Activate what already drives growth.", copy: "Connect people, digital presence, reputation, and customer signals into a more intentional growth conversation.", image: "/media/assets.png", alt: "DREAMS Score Assets opportunity panel" },
  { id: "credits", code: "M", channel: "Money & Tax Credits", title: "Explore overlooked opportunity paths.", copy: "Identify business-credit and tax-credit questions that could be worth taking to qualified specialists.", image: "/media/credits.png", alt: "DREAMS Score Money and Tax Credits opportunity panel" },
  { id: "security", code: "S", channel: "Security", title: "Protect the enterprise you have built.", copy: "Review resilience, continuity, key-person, and technology-risk questions in one disciplined conversation.", image: "/media/security.png", alt: "DREAMS Score Security opportunity panel" },
];
